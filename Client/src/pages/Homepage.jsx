                ...
                <div class="row ">
                    ...
                    <div class="col-5 mt-5">
                        <div className="row " style={{ marginTop: "60px" }}>
                            <h1 className='text-white' style={{ letterSpacing: "8px", textAlign: "center", fontSize: "60px" }}>EMOTION</h1><br />
                            <h2 style={{ letterSpacing: "15px", textAlign: "center", color: "#f5eeed", fontSize: "55px" }}>DETECTION</h2>
                            <hr style={{ border: "2px solid white", width: "75%", marginLeft: "11%" }} />
                        </div>
